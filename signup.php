...
<head>
    <meta charset="utf-8">
    <title>Persona Learn : Signup</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="index.html" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <p class="m-0 fw-bold" style="font-size: 25px;"><img src="img/icon.png" alt="" height="50px">Persona<span
                    style="color: #fb873f;">Learn</span></p>
        </a>
                ...
                <center>
                    <form action="" method="POST" class="shadow p-4" style="max-width: 550px;">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <button class="btn text-light w-100 py-3" name="submit" type="submit" role="button">Signup</button>
                            </div>                            
